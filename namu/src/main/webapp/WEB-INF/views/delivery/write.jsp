...
function ajaxFun(url, method, formData, dataType, fn, file = false) {
	...
	function isPoint() {
	    ...
	    let query = $.param({ inputPoint: pointValue }); // 쿼리 문자열 생성
		...
		<form name="deliveryForm" method="post" enctype="multipart/form-data">
			<table class="table mt-5 write-form">
				...
				<tr>
					...
					<td scope="row">
						<div style="display: flex; align-items: center;">
							<input type="text" name="saddr" class="form-control" readonly
								value="${dto.saddr1}" id="saddr"
								style="width: 70%; margin-right: 5px;">
							<button class="btn btn-primary" type="button"
								onclick="daumPostcode();" style="flex-shrink: 0;">주소 검색</button>
						</div> <input type="text" class="form-control" id="saddr2" name="saddr2"
						value="${dto.saddr2}" placeholder="상세주소">
					</td>
				</tr>
				...
				<tr>
					...
					<td scope="row">
						<div style="display: flex; align-items: center;">
							<input type="text" name="receive" class="form-control" readonly
								value="${dto.receive}" id="receive"
								style="width: 70%; margin-right: 5px;">
							<button class="btn btn-primary" type="button"
								onclick="daumPostcode2();" style="flex-shrink: 0;">주소
								검색</button>
						</div> <input type="text" class="form-control" id="receive2"
						name="receive2" value="${dto.receive2}" placeholder="상세주소">
					</td>
				</tr>
				...
				<tr>
					...
					<td><textarea name="content" id="" class="form-control"
			...
			<table class="table table-borderless">
				<tr>
					<td class="text-center">
						<button type="button" class="btn btn-dark" onclick="check();">${mode=='update'?'수정완료':'등록하기'}&nbsp;<i
