...
<div class="container">
  ...
  <main class="container">
   	<div class="body-title">
		<h2>전체 게시글</h2>
		<form class="row" name="searchForm" action="${pageContext.request.contextPath}/delivery/list" method="post">
            <div class="filter-container">
                ...
                <button type="button" class="search-button" onclick="location.href='${pageContext.request.contextPath}/delivery/write';">글올리기</button>
            </div>
        </form>		
	</div>
                ...
                <tbody>
                    ...
                    <tr>
	                  	...
	                  	<td>${dataCount -(page-1) * size - status.index}</td>
	                    	<td class="left">
	                    		<c:url var="url" value="/delivery/article">
	                    		...
	                    		<a href="${url}" class="text-rest">${dto.point}</a>
